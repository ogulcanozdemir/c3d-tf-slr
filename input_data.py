...
def read_clip_and_label(filename, batch_size, start_pos=-1, num_frames_per_clip=16, crop_size=112, shuffle=False, crop_mean='crop_mean.npy'):
	...
	next_batch_start = -1
	lines = list(lines)
	np_mean = np.load(crop_mean).reshape([num_frames_per_clip, crop_size, crop_size, 3])
